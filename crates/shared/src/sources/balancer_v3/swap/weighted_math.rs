...
mod tests {
    ...
    fn stops_large_trades() {
        let balance = Bfp::from_wei(100_000_000_000_000_000_000_000_u128.into());
        let weight = Bfp::from_wei(500_000_000_000_000_000_u128.into());
        let max_in_amount = balance.mul_down(*MAX_IN_RATIO).unwrap();
        let max_out_amount = balance.mul_down(*MAX_OUT_RATIO).unwrap();

        // These should succeed
        calc_out_given_in(balance, weight, balance, weight, max_in_amount).unwrap();
