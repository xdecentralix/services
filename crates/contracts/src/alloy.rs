...
crate::bindings!(BalancerV2GyroECLPPool);
crate::bindings!(BalancerV2Gyro2CLPPool);
crate::bindings!(BalancerV2Gyro3CLPPool);
crate::bindings!(
    ...
    crate::deployments! {
        ...
        ARBITRUM_ONE => (address!("0x7dFdEF5f355096603419239CE743BfaF1120312B"), 222863),
...
crate::bindings!(
    ...
    crate::deployments! {
        ...
        ARBITRUM_ONE => (address!("0xf1665E19bc105BE4EDD3739F88315cC699cc5b65"), 58948306),
        // <https://etherscan.io/tx/0x39f357b78c03954f0bcee2288bf3b223f454816c141ef20399a7bf38057254c4>
        MAINNET => (address!("0x5Dd94Da3644DDD055fcf6B3E1aa310Bb7801EB8b"), 16580891),
        // <https://gnosisscan.io/tx/0x2ac3d873b6f43de6dd77525c7e5b68a8fc3a1dee40303e1b6a680b0285b26091>
        GNOSIS => (address!("0xC128a9954e6c874eA3d62ce62B468bA073093F25"), 26365799),
        ...
        // Not available on Sepolia, Base (only version ≥ 4)
        // <https://docs.balancer.fi/reference/contracts/deployment-addresses/sepolia.html>
...
crate::bindings!(
    ...
    crate::deployments! {
        ...
        // Not available on Sepolia, Lens
        // <https://docs.balancer.fi/reference/contracts/deployment-addresses/sepolia.html>
        // <https://docs.balancer.fi/reference/contracts/deployment-addresses/lens.html>
    }
);
crate::bindings!(
...
crate::bindings!(
    ...
    crate::deployments! {
        ...
        SEPOLIA => (address!("0x45fFd460cC6642B8D8Fb12373DFd77Ceb0f4932B"), 3419649),
...
crate::bindings!(
    ...
    crate::deployments! {
        ...
        ARBITRUM_ONE => (address!("0x7a36527A02d96693b0AF2b70421F952816a4a088"), 194367293),
        // <https://polygonscan.com/tx/0x858e060ad6048afbf16a8acdf14ea2526b30e9cdcb987a5a6e348a90a3443576>
        POLYGON => (address!("0x5d8545a7330245150bE0Ce88F8afB0EDc41dFc34"), 31556084),
        // Only available on Arbitrum One and Polygon
    }
);
crate::bindings!(
    ...
    crate::deployments! {
        ...
        POLYGON => (address!("0x90f08B3705208E41DbEEB37A42Fb628dD483AdDa"), 31556094),
